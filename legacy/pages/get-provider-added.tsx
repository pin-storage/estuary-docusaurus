...
function GetProviderAdded(props) {
  ...
  return (
    <App
      title="Pin.Storage Documentation: Storage Provider Application"
      description="Fill out this form to get added to Pin.Storage so you can receive storage deals."
      ...
      {state.success ? (
        ...
        <div className={U.classNames(styles.group, rstyles.block)}>
          ...
          <p>
            ...
            and receive verified Filecoin storage deals? Please fill out this
            form! If we believe your provider is qualified we will add it to our
            provider index and you will receive storage deals.
          </p>
