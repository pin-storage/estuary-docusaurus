...
const code = `class Example extends React.Component {
  componentDidMount() {
    fetch('https://api.pin.storage/collections/list', {
      method: 'GET',
      headers: {
...
const curl =
  'curl -X GET -H "Authorization: Bearer REPLACE_ME_WITH_API_KEY" https://api.pin.storage/collections/list';

function APICollectionsList(props) {
  return (
    <App
      title="Pin.Storage Documentation: API: /collections/list"
      description="https://api.pin.storage/collections/list"
      url="https://docs.pin.storage/api-collections-list"
